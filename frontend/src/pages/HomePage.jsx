...
//we are calling the hook useproduct 
function HomePage() {
  //this is destructuring 
  const { data: rawData, isLoading, error } = useProducts();
  
  // Extract the array, whether it is hiding inside .data, .products, or is already an array
  const products = Array.isArray(rawData) ? rawData : (rawData?.data || rawData?.products || []);
  ...
  return (
    <div className="space-y-10">
      ...
      <div>
        ...
        ) : (//if we have product show the card else blank 
